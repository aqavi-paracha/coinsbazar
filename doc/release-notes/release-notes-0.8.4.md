CoinsBazar-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/CoinsBazar/bitcoin-0.8.4/
...
code, causing the CoinsBazar-Qt or bitcoind process to crash.
...
their own version of CoinsBazar against Boost versions 1.50-1.52.
