...
The Amazon Machine Images I used to do the builds are available:
  ...
  ami-38a05251   CoinsBazar-v0.3.20.2 Mingw    (Windows; Administrator password 'bitcoin development')
  ami-30a05259   CoinsBazar_0.3.20.2 Linux32
  ami-8abc4ee3   CoinsBazar_0.3.20.2 Linux64
