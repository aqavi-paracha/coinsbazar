CoinsBazar version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/CoinsBazar/bitcoin-0.5.4/
...
Fix CoinsBazar-Qt notifications under Growl 1.3.
Increase required age of CoinsBazar-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCoinsBazar properly when installing CoinsBazar-Qt over it. (Windows)
