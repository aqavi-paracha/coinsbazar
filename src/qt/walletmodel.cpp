...
{
    CCoinsBazarAddress addressParsed(address.toStdString());
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // User-entered bitcoin address / amount:
            ...
            scriptPubKey.SetDestination(CCoinsBazarAddress(rcp.address.toStdString()).Get());
...
{
    QString strAddress = QString::fromStdString(CCoinsBazarAddress(address).ToString());
...
void WalletModel::listCoins(std::map<QString, std::vector<COutput> >& mapCoins) const
{
    ...
    BOOST_FOREACH(const COutput& out, vCoins)
    {
        ...
        mapCoins[CCoinsBazarAddress(address).ToString().c_str()].push_back(out);
    }
}
...
{
    CTxDestination dest = CCoinsBazarAddress(sAddress).Get();
