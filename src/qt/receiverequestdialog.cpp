...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCoinsBazarURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CoinsBazarUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCoinsBazarURI(info));
}
